...
const WHATSAPP_NUMBER = "237699948421"; // ← remplacez par votre numéro (avec indicatif, sans +)
...
function WhatsAppButton() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <span className="opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all duration-200 bg-white text-[#0a4d7c] text-sm font-semibold px-4 py-2 rounded-full shadow-lg border border-gray-100 whitespace-nowrap pointer-events-none">
      ...
      >
        ...
        />
        <FaWhatsapp className="w-7 h-7 text-white relative z-10" size={28} />
      </div>
    </motion.a>
  );
}
