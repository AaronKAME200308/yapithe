...
const Services = () => {
  ...
  const services: Service[] = [
    ...
    },
    {
      ...
      description: "Analyse des coûts pour mesurer la rentabilité et aider à la prise de décision.",
    ...
    },
    {
      ...
      description: "Méthodes et tableaux de pilotage pour planifier, contrôler et ajuster les performances financières.",
    ...
    },
    {
      id: 4,
      title: "Formation",
      description: "Développement des compétences en pilotage financier, analyse des écarts et optimisation des coûts.",
