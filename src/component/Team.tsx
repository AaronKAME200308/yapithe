  ...
  const members = [
    {
    ...
    },
     {
      ...
      role: "Directeur Général Adjoint en charge du développement",
      img: "/membre14.png",
      bio: "Expert en Contrôle de gestion & pilotage de la performance ",
    ...
    },
    {
      ...
      role: "Directeur Général Adjoint  en charge de la gestion des opérations",
      img: "/membre2.png",
      bio:"Expert en Contrôle de gestion & pilotage de la performance",
    ...
    },
    {
      ...
      linkedin: "https://www.linkedin.com/in/williams-bamatabina-a3804a141/",
      email: "william.bamatabina@yapithepartners.com",
      featured: false,
    },
    // {
    //   name: "Paola KOUMDA",
    ...
    // {
    //   name: "Ndonkeu Tchoua Marushka Lyne",
    //   role: "Consultante",
    //   img: "/membre13.png",
    //   bio:"Contrôle de gestion & pilotage de la performance",
    //   linkedin: "",
    //   email: "lyne.ndonkeutchoua@yapithepartners.com",
    //   featured: false,
    // },
    // {
    ...
    //   bio:"Contrôle de gestion & pilotage de la performance",
    //   linkedin: "",
    //   email: "nwaha.onana@yapithepartners.com",
    //   featured: false,
    // },  
    {
      name: "Brya Amandine",
      ...
      bio:"Contrôle de gestion & pilotage de la performance",
      linkedin: "",
      email: "brya.amandine@yapithepartners.com",
      featured: false,
    },
    {
      name: "Handjou Djillia Michèle Andréa",
      role: "Consultante",
      img: "",
      bio:"Contrôle de gestion & pilotage de la performance",
      linkedin: "https://www.linkedin.com/in/handjou-mich%C3%A8le-andr%C3%A9a-360a76210/",
      email: "andreahandjou@yapithepartners.com",
      featured: false,
    },
