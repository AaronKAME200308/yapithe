...
export const ChroniquesPage = () => {
    ...
    return (
        <>
            {/* SECTION PRINCIPALE */}
            <section className="w-full py-16 md:py-24 bg-linear-to-br from-[#0a4d7c] via-[#0c5d94] to-[#0a4d7c]">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    <div className="mb-10">
                        <button
                            onClick={() => navigate(-1)}
                            className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-5 py-2 rounded-full backdrop-blur-md border border-white/20 transition"
                        >
                            ← Retour
                        </button>
                    </div>
